...
public class MiniRustParser extends Parser {
	...
	public static class SingleTermContext extends ExprContext {
		...
		public SingleTermContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniRustVisitor ) return ((MiniRustVisitor<? extends T>)visitor).visitSingleTerm(this);
	...
	public static class SingleFactorContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniRustVisitor ) return ((MiniRustVisitor<? extends T>)visitor).visitSingleFactor(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NumberContext extends FactorContext {
		public TerminalNode NUMBER() { return getToken(MiniRustParser.NUMBER, 0); }
	...
	public static class ParenthesesContext extends FactorContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniRustVisitor ) return ((MiniRustVisitor<? extends T>)visitor).visitParentheses(this);
			else return visitor.visitChildren(this);
		}
	}
